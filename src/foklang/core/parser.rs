...
impl Parser {
  ...
  pub fn parse(&mut self, static_tokens: Vec<Token>) -> AST::Node {
    ...
    let mut result = AST::Node{kind: AST::NodeKind::Fokcord{body: Vec::<Box<AST::Node>>::new(), id: 0}};
  ...
  pub fn parse_stmt(&mut self, tokens: &mut Vec<Token>, depth: i64) -> AST::Node {
  ...
  pub fn parse_hstmts(&mut self, tokens: &mut Vec<Token>, depth: i64) -> AST::Node {
  ...
  pub fn parse_type_declaration(&mut self, tokens: &mut Vec<Token>, depth: i64) -> AST::Node {
  ...
  pub fn parse_statements(&mut self, tokens: &mut Vec<Token>, depth: i64) -> AST::Node {
  ...
  pub fn parse_expr(&mut self, tokens: &mut Vec<Token>, depth: i64) -> AST::Node {
  ...
  pub fn parse_additive_expr(&mut self, tokens: &mut Vec<Token>, depth: i64) -> AST::Node {
  ...
  pub fn parse_multiplicative_expr(&mut self, tokens: &mut Vec<Token>, depth: i64) -> AST::Node {
  ...
  pub fn parse_exponential_expr(&mut self, tokens: &mut Vec<Token>, depth: i64) -> AST::Node {
  ...
  pub fn parse_secondary_expr(&mut self, tokens: &mut Vec<Token>, depth: i64) -> AST::Node {
  ...
  pub fn parse_primary_expr(&mut self, tokens: &mut Vec<Token>, depth: i64) -> AST::Node {
